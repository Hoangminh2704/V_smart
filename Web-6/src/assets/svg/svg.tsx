...
export const CartFillIcon: React.FC<IconProps> = ({ className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
  ...
  >
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M1.26456 2.9429C1.3458 2.53673 1.74092 2.27332 2.14709 2.35455L3.19645 2.56442C4.3817 2.80147 5.27321 3.78466 5.39348 4.98739L5.47874 5.83999H19.0542C21.0385 5.83999 22.4944 7.70472 22.0131 9.62972L20.8904 14.1208C20.4174 16.0127 18.7175 17.34 16.7673 17.34H7.77435C6.3823 17.34 5.20979 16.2998 5.04394 14.9176L4.05446 6.67199L3.90092 5.13664C3.84626 4.58995 3.44102 4.14305 2.90227 4.0353L1.85291 3.82542C1.44674 3.74419 1.18333 3.34907 1.26456 2.9429ZM8.99986 12.8398C8.58564 12.8398 8.24986 13.1756 8.24986 13.5898C8.24986 14.0041 8.58564 14.3398 8.99986 14.3398H12.9999C13.4141 14.3398 13.7499 14.0041 13.7499 13.5898C13.7499 13.1756 13.4141 12.8398 12.9999 12.8398H8.99986Z"
      fill="#1E2B36"
    />
    <path
      d="M10 20.0898C10 20.9183 9.32843 21.5898 8.5 21.5898C7.67157 21.5898 7 20.9183 7 20.0898C7 19.2614 7.67157 18.5898 8.5 18.5898C9.32843 18.5898 10 19.2614 10 20.0898Z"
      fill="#1E2B36"
    />
    <path
      d="M19 20.0898C19 20.9183 18.3284 21.5898 17.5 21.5898C16.6716 21.5898 16 20.9183 16 20.0898C16 19.2614 16.6716 18.5898 17.5 18.5898C18.3284 18.5898 19 19.2614 19 20.0898Z"
      fill="#1E2B36"
    />
  </svg>
);
